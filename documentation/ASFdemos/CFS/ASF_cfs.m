...
Cfg.userSuppliedTrialFunction = @showTrialCFS;
Cfg.userDefinedSTMcolumns = 8;
...
[ExpInfo] = ASF('CFSDemo.std', 'CFSDemo.trd', 'testsubject', Cfg); %FROM ASF's DEMO DIRECTORY
