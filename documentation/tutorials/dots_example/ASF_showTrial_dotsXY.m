function TrialInfo = ASF_showTrial_dotsXY(atrial, windowPtr, Stimuli, Cfg)
%function TrialInfo = ASF_showTrial_dotsXY(atrial, windowPtr, Stimuli, Cfg)
%
%derived from ASF_showTrialSample
...
function drawFix(windowPtr, Cfg, fixColor)
%OVERLAY FIXATION POINT
%SYNTAX
%Screen('DrawDots', windowPtr, xy [,size] [,color] [,center] [,dot_type]);

%Screen('DrawDots', windowPtr, [ Cfg.Screen.centerX + Cfg.Fixation.offsetX,  Cfg.Screen.centerY + Cfg.Fixation.offsetX], 15, fixColor, [], 2)
%Screen('DrawDots', windowPtr, [ Cfg.Screen.centerX + Cfg.Fixation.offsetX,  Cfg.Screen.centerY + Cfg.Fixation.offsetX], 5, 255-fixColor, [], 2)


fromH =  Cfg.Screen.centerX + Cfg.Fixation.offsetX;
toH = fromH;
fromV =  Cfg.Screen.centerY + Cfg.Fixation.offsetY - 10;
toV =  Cfg.Screen.centerY + Cfg.Fixation.offsetY + 10;
Screen('DrawLine', windowPtr, fixColor, fromH, fromV, toH, toV, 1);

fromH =  Cfg.Screen.centerX + Cfg.Fixation.offsetX - 10;
toH = Cfg.Screen.centerX + Cfg.Fixation.offsetX + 10;
